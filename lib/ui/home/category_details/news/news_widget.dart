...
class _NewsWidgetState extends State<NewsWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: RetrofitServices(Dio())
          .getNewsBySourceId(ApiConstants.apiKey, widget.source.id ?? ''),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Column(
            children: [
              Text(
                AppLocalizations.of(context)!.client_error,
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    RetrofitServices(Dio()).getNewsBySourceId(
                        ApiConstants.apiKey, widget.source.id ?? '');
                    setState(() {});
                  },
                  child: Text(
